...
int main(void) {
    ...
    RUN_TEST(test_lexer_ignores_line_comments_and_tracks_next_token_position, "tests/lexer/test_lexer.c");
    ...
    RUN_TEST(test_semantic_accepts_char_array_initialized_from_string_literal, "tests/semantic/test_semantic.c");
    ...
    RUN_TEST(test_semantic_accepts_general_array_to_pointer_decay_in_assignment, "tests/semantic/test_semantic.c");
    RUN_TEST(test_semantic_accepts_general_array_to_pointer_decay_in_call_arguments, "tests/semantic/test_semantic.c");
    RUN_TEST(test_semantic_rejects_too_small_char_array_initialized_from_string_literal, "tests/semantic/test_semantic.c");
    ...
    RUN_TEST(test_semantic_accepts_pointer_indexing, "tests/semantic/test_semantic.c");
    ...
    RUN_TEST(test_ir_printer_decays_string_literal_for_char_pointer_initializer, "tests/ir/test_ir.c");
    ...
    RUN_TEST(test_ir_printer_emits_else_if_chain, "tests/ir/test_ir.c");
    ...
    RUN_TEST(test_ir_printer_initializes_unsized_char_array_from_string_literal, "tests/ir/test_ir.c");
    RUN_TEST(test_ir_printer_decays_array_argument_to_pointer_parameter, "tests/ir/test_ir.c");
